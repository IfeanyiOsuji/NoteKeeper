...
public class NoteListActivityTest {
    ...
    public void noteListActivityTest() {
        ...
        ViewInteraction appCompatMultiAutoCompleteTextView2 = onView(
                allOf(withId(R.id.text_note_text), withText("Content A"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
                                1),
                        isDisplayed()));
        appCompatMultiAutoCompleteTextView2.perform(replaceText("Title  A"));

        ViewInteraction appCompatMultiAutoCompleteTextView3 = onView(
                allOf(withId(R.id.text_note_title1), withText("Title  A"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction appCompatMultiAutoCompleteTextView4 = onView(
                allOf(withId(R.id.text_note_title1), withText("Title  A"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatMultiAutoCompleteTextView4.perform(click());
        ...
        ViewInteraction appCompatMultiAutoCompleteTextView5 = onView(
                allOf(withId(R.id.text_note_title1), withText("Title  A"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatMultiAutoCompleteTextView5.perform(click());
    }
